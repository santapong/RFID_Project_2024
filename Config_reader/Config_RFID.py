...
class RFIDReader:
    ...
    def find_rfid_reader(self):
        try:
            ...
            devices = usb.core.find(find_all=True, idVendor=0x076b, idProduct=0x5128)
            for dev in devices:
                try:
...
if __name__ == "__main__":
    serial_number = "01010053505638313013421947195730"  # หมายเลขซีเรียลของอุปกรณ์
    device_path = "1-1.3"  # ปรับให้ตรงกับตำแหน่งอุปกรณ์
